...
android {
    ...
    signingConfigs {
        create("release") {
            ...
            if (!ksPath.isNullOrBlank()) {
                ...
                storePassword = System.getenv("PLINK_KEYSTORE_PASSWORD") ?: ""
                keyAlias = System.getenv("PLINK_KEY_ALIAS") ?: "plink"
                keyPassword = System.getenv("PLINK_KEY_PASSWORD") ?: ""
            }
        }
    }
    ...
    buildTypes {
        release {
            ...
            if (!System.getenv("PLINK_KEYSTORE_PATH").isNullOrBlank()) {
