...
private enum FriendsHubSegment: Int, CaseIterable, Identifiable {
    case friends = 0
    case chats = 1
    // 25.08.2026 (T4): сегмента истории здесь больше нет — совместные
    // просмотры переехали во вкладку «Комнаты» таб-бара,
...
struct V4FriendsViewLive: View {
    ...
    // История «с кем и что смотрели» переехала на вкладку «Комнаты»
