// Stable rotation
//
// GLM-5.2 master implementation patch — Commit Group 2.
//
...
//
// Critical rule: all three layouts (portrait / landscape /
...
//
// Animation: 0.4s smooth spring with damping >= 0.9.
...
extension Animation {
    // Use .spring(duration:bounce:) which is available on iOS 13+,
