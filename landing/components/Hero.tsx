  ...
  return (
    <section className="relative overflow-hidden" aria-label="Plink — совместный просмотр видео">
      ...
      <div className="absolute inset-0" aria-hidden="true">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(75%_55%_at_50%_38%,rgb(var(--bg)_/_0.82),transparent_72%)]" />
      ...
      <div className="relative z-10 flex min-h-[92vh] flex-col items-center justify-center px-6 pt-24 text-center">
        ...
        >
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <StoreCta
              className="inline-flex items-center gap-2.5 rounded-full bg-accent px-8 py-4 text-[15px] font-semibold text-bg shadow-[0_10px_36px_-8px_rgb(var(--accent)_/_0.55)] transition-all duration-300 hover:-translate-y-0.5 hover:bg-accent-dim hover:shadow-[0_16px_44px_-10px_rgb(var(--accent)_/_0.65)] focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2 focus:ring-offset-bg"
              icon={
                <svg
                  width="18"
                  height="18"
            ...
            <a
              href="#how-it-works"
              className="liquid-glass liquid-glass-interactive group inline-flex items-center gap-2 rounded-full px-7 py-4 text-[15px] font-medium text-text-primary transition-transform duration-300 hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-accent"
            >
              Как это работает
              <span
                aria-hidden="true"
