...
const DEVICES: readonly DeviceState[] = [
...
// -- Device Frame (memoized subcomponent) -----------------------------------
...
function DeviceFrame({
  ...
  const ySpring = useTransform(smoothY, (v) => v * multY);
  const springX = useSpring(x, { stiffness: 150, damping: 25 });
  const springY = useSpring(ySpring, { stiffness: 150, damping: 25 });
          ...
          <div className="absolute inset-x-0 top-0 h-[70%] overflow-hidden">
            <div className="relative h-full w-full bg-gradient-to-br from-[#1a1a2e] to-[#16213e]">
              ...
              <div className="absolute right-3 top-3 z-20 flex items-center gap-1.5 rounded-full bg-black/60 px-2.5 py-1 backdrop-blur-sm">
                <div
                  className={`h-1.5 w-1.5 rounded-full ${isPaused ? "bg-sync" : "bg-accent"} ${
        ...
        <div
          ...
          style={{
            background: `radial-gradient(ellipse at center, ${
              isHoveringPause ? "rgba(255,92,57,0.4)" : "rgba(200,255,61,0.3)"
            } 0%, transparent 70%)`,
          }}
        />
      )}
          ...
          <div className="lg:col-span-5 lg:col-start-1">
            ...
            >
              ...
              <p className="mt-8 max-w-md text-lg leading-relaxed text-text-secondary">
                Смотри YouTube, VK Видео и Rutube синхронно с друзьями. Создай комнату,
                отправь код — и смотрите вместе, где бы вы ни были.
              </p>
