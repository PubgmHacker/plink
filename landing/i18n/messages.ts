...
export const messages: Record<Locale, Record<string, string>> = {
  ru: {
    ...
    'features.subtitle':
      'Ни один скриншот не отфотошоплен — всё снято с самого приложения, как есть.',
  ...
  en: {
    ...
    'how.step3.desc': 'Paste a YouTube, VK or Rutube link. All devices sync automatically.',
