...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    description: 'Смотри видео синхронно с друзьями: один кадр, одна пауза, одни эмоции.',
    images: ['/og-image.png'],
  },
  robots: {
    index: true,
  ...
  return (
    ...
    >
      <body className="min-h-screen bg-bg text-text-primary antialiased">
        <a
          href="#main"
          className="sr-only focus:not-sr-only focus:absolute focus:left-4 focus:top-4 focus:z-50 focus:rounded focus:bg-accent focus:px-4 focus:py-2 focus:font-medium focus:text-bg"
        >
